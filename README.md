...
A solução para isso foi o FOS CLI, onde através de um terminal simples ele atua como uma estante local onde o usuário é o dono dos seus dados. Nela ocorre:
...
---
### **`Como instalar:`**
Para rodar o FOS CLI na máquina, é nescessário ter o Node.js instalado. Siga os passos abaixo no seu terminal:
1. Clone o repositório:
   - git clone https://github.com/Lara535/Bootcamp.II-Entrega_Inicial.git
2. Entre na pasta do projeto:
   - cd Bootcamp.II-Entrega_Inicial
3. O projeto utiliza a biblioteca readline-sync para capturar os dados no terminal. Para instalá-la, rode:
   - npm install
---
### **`Como usar:`**
Com tudo instalado, poderá usar o FOS CLI de forma rápido e fácil!
1. Inicie a aplicação abrindo o terminal, onde dentro da pasta do projeto digite o seguinte comando:
   - node src/index.js
 2. Para preencer as informações, o sistema fará 4 perguntas rápidas. Basta digitar ou colar as informações da fanfic que você deseja salvar e aperta Enter após cada uma:
   - 
